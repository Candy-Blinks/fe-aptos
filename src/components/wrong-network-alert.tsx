  ...
  return !connected || network?.name === NETWORK ? (
    ...
    <Dialog.Root open={true}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg rounded-lg p-6 bg-white transition-transform duration-300 ease-in-out w-[90vw] max-w-md">
          <div className="text-center">
            <Dialog.Title className="text-3xl font-semibold mb-4 text-gray-100">
              Wrong Network
            </Dialog.Title>
