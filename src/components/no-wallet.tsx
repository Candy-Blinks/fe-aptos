    ...
    <div className="min-h-screen bg-black-100 flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image src={`${ASSETS_URL}cmb_bg4.png`} alt="Background" fill priority className="object-cover" />
        </div>

        {/* Content */}
        <div className="container relative z-20 flex flex-col items-center justify-center px-5 text-center max-w-2xl">
          <h1 className="text-7xl md:text-9xl lg:text-[10rem] font-bold tracking-tight text-white">Oops!</h1>
